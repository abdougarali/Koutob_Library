...
export default function BookDetailsError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error("Book details error:", error);
  }, [error]);

  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col items-center justify-center gap-6 px-6 py-32 text-center">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="max-w-md text-base text-[color:var(--color-foreground-muted)]">
          {error.message || "حدث خطأ أثناء تحميل تفاصيل الكتاب. يرجى المحاولة مرة أخرى."}
        </p>
      </div>
